...
configurable_parameters = [
			    #{'name': 'depth_info_qos',               'default': 'SENSOR_DATA', 'description': 'depth qos'},
			    #{'name': 'color_info_qos',               'default': 'SENSOR_DATA', 'description': 'depth qos'},
			    {'name': 'depth_qos',                    'default': 'SENSOR_DATA', 'description': 'depth qos'},
			    {'name': 'color_qos',                    'default': 'SENSOR_DATA', 'description': 'depth qos'},
