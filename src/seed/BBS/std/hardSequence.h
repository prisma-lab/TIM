#ifndef BEHAVIOR_HARD_SEQUENCE_H
#define BEHAVIOR_HARD_SEQUENCE_H

#include "seed.h"

using namespace seed; //this is not needed to compile, byt most IDEs require it

class HardSequenceBehavior : public Behavior {
public:
    HardSequenceBehavior(std::string instance);
...
#endif	/* BEHAVIOR_HARD_SEQUENCE_H */
